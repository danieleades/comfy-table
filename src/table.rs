...
impl Table {
    ...
    /// column.\ There'll be no header unless you explicitly set it with
    /// this function.
    ///
    /// ```
    ...
    /// content arrangement](ContentArrangement::Dynamic).\ This is usually
    /// not necessary, if you plan to output your table to a tty,
    ...
    /// line of this column.\ This is mostly needed for internal testing and
    /// formatting, but can be interesting if you want to see the widths of
    /// the longest lines for each column.
