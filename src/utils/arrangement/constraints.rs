...
/// column. \ Lower boundaries with [Width::Fixed] just return their internal
/// value. \ Lower boundaries with [Width::Percentage] return the percental
/// amount of the current table width.
...
///
/// This returns the value of absolute characters that are allowed to be in this
/// column. \ Upper boundaries with [Width::Fixed] just return their internal
/// value. \ Upper boundaries with [Width::Percentage] return the percental
/// amount of the current table width.
