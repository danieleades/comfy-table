...
/// Apply all non-relative constraints, and set the width of all remaining
/// columns to the respective max content width.
pub fn arrange(table: &Table, infos: &mut DisplayInfos, visible_columns: usize) {
    for column in table.columns.iter() {
        ...
        // Reduce the width, if a column has longer content than the specified MaxWidth
        // constraint.
